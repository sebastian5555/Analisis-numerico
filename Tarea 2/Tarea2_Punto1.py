...
def trapezoidal(x):
    ...
    for i in puntos:
        y.append(integrate.trapz(TMG(x,i), x))
    return(y)

T1 = trapezoidal(intervals(a,b,0.01))
T2 = trapezoidal(intervals(a,b,0.05))
T3 = trapezoidal(intervals(a,b,0.1))
T4 = trapezoidal(intervals(a,b,0.5))
T5 = trapezoidal(intervals(a,b,1))
puntos= np.linspace(0,1, 500)
